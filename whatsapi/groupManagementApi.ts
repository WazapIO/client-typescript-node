...
export class GroupManagementApi {
     ...
     * @param groupId Group id of the group
     */
    public async getAllParticipants (instanceKey: string, groupId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: APIResponse;  }> {
        const localVarPath = this.basePath + '/instances/{instance_key}/groups/{group_id}/participants'
            .replace('{' + 'instance_key' + '}', encodeURIComponent(String(instanceKey)))
            .replace('{' + 'group_id' + '}', encodeURIComponent(String(groupId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async joinGroupWithLink (instanceKey: string, inviteCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: APIResponse;  }> {
        const localVarPath = this.basePath + '/instances/{instance_key}/groups/join'
            .replace('{' + 'instance_key' + '}', encodeURIComponent(String(instanceKey)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['*/*'];
        ...
        if (inviteCode !== undefined) {
            localVarQueryParameters['invite_code'] = ObjectSerializer.serialize(inviteCode, "string");
        }
