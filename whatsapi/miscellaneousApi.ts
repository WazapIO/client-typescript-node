...
export class MiscellaneousApi {
     ...
     * @param jid JID
     */
    public async instancesInstanceKeyMiscProfilePicGet (instanceKey: string, jid: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MainAPIResponse;  }> {
     ...
     * @param data Data
     */
    public async instancesInstanceKeyMiscUserInfoPost (instanceKey: string, data: StructsUserInfoPayload, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MainAPIResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(data, "StructsUserInfoPayload")
        };
